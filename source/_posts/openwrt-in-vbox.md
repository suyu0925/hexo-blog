...
OpenWrt官方已经给出了指南：[在Virtualbox虚拟机中运行OpenWrt](https://openwrt.org/zh/docs/guide-user/virtualization/virtualbox-vm)，直接对照着做就行。
...
扩容root大致可以分两步，先是[挂载新硬盘](https://openwrt.org/docs/guide-user/storage/usb-drives)获得新的存储空间，再是[扩容root](https://openwrt.org/docs/guide-user/additional-software/extroot_configuration)。
